...
<div class="wrap dlcg-admin-wrap">
    ...
    <div class="dlcg-admin-container">
        <div class="dlcg-admin-card">
            <h2>Welcome to DailyLiife Classic Games v1.7.3</h2>
            <p>Add any of these games to your WordPress pages or posts using the shortcodes below.</p>
            <div style="background: #e7f7ff; border-left: 4px solid #0891b2; padding: 12px; margin-top: 15px;">
                <strong>✨ New in v1.7.3:</strong>
                <ul style="margin: 10px 0 0 20px;">
                    <li>Enhanced mobile responsive design - games now resize to fit screens ≤480px without horizontal scrolling</li>
                    <li>Empty stock pile visual indicators with rewind icons for better gameplay clarity</li>
                    <li>Improved fullscreen button positioning for better accessibility</li>
                    <li>Minesweeper difficulty selection popup - choose your challenge level in-game</li>
                    <li>Minesweeper mode toggle with visual indicators (emoji 😊 or classic #)</li>
                    <li>Better card spacing on FreeCell and Spider tableaus</li>
                    <li>Optimized layout for small screens with reduced margins</li>
                </ul>
            </div>
        </div>
