...
$mode = isset($atts['mode']) ? $atts['mode'] : 'single';
?>
<div class="dlcg-game-container" data-game="solitaire">
    <div class="dlcg-game-header">
        <div class="dlcg-game-title">
            <h2>Solitaire</h2>
            <span class="dlcg-game-mode"><?php echo $mode === 'three' ? '3-Card Draw' : 'Single Card'; ?></span>
        </div>
    ...
    <div class="dlcg-game-board" id="solitaire-board" data-mode="<?php echo esc_attr($mode); ?>"></div>
</div>
